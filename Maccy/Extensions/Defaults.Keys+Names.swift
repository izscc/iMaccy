...
extension Defaults.Keys {
  ...
  static let confirmPromptBulkDelete = Key<Bool>("confirmPromptBulkDelete", default: true)
  static let defaultLibraryScope = Key<LibraryScope>("defaultLibraryScope", default: .history)
  ...
  static let promptRecentBookmarkLimit = Key<Int>("promptRecentBookmarkLimit", default: 3)
  static let showFooter = Key<Bool>("showFooter", default: true)
  static let showPromptCategoryBadge = Key<Bool>("showPromptCategoryBadge", default: true)
  static let showPromptTagSummary = Key<Bool>("showPromptTagSummary", default: true)
